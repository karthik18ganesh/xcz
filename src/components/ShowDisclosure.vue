    ...
    <v-container>
        ...
        >
            <template v-slot:activator="{ on, attrs }">
                ...
                v-on="on"
                >
                <img src="../assets/showdisclosure.png" width="60" height="22">
                </p>
            </template>
            <v-card class="mx-auto" width="800">
                <v-toolbar dense flat>
                    ...
                    >
                        <template v-slot:activator="{ on, attrs }">
                            <button style="color: rgba(3, 169, 244, 1);" v-on="on" v-bind="attrs">
                                <img src="../assets/plus.png" alt="">
                                Add Disclosure
                            </button>
                        </template>

                        <v-card max-width="980" class="mx-auto" flat>
                            <v-toolbar flat>
                                <h5>Disclosures</h5>
                            </v-toolbar>
                            ...
                            <v-layout style="margin:20px">
                                <v-flex xs4 md4>
                                    ...
                                    label="Title of the explanation"></v-select>
                                </v-flex>
                            </v-layout>
                                ...
                                <v-toolbar dense flat style="padding:1px">
                                    ...
                                    <v-select dense
                                     outlined style="margin:10px"></v-select>
                                ...
                                <div class="divClass">
                                    <v-textarea placeholder="Type Here"></v-textarea>
                                </div>
                                

                            <div class="div-btn">
                                <v-btn flat small color="primary" style="margin-right:2%"> Add </v-btn>
                                <v-btn flat small @click="addDisclosureDialog = false"> Cancel </v-btn>
                            </div>
                        </v-card>
                    </v-dialog>
                ...
                <v-simple-table>
                    ...
                    <tbody>
                        <tr>
                            <td style="text-align:left"> Title one </td>
                            <td style="text-align:left">
                                <button transparent><img src="../assets/edit.png" alt=""></button>
                                <button transparent><img src="../assets/delete.png" alt=""></button>
                            </td>
                        </tr>
                    </tbody>
                </v-simple-table>
