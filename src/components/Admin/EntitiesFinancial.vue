    ...
    >
      ...
      <v-card>
        ...
        <v-card-text class="mt-3">
            <v-row>
                <v-form ref="addFinancialForm" style="width:100%">
          <v-col cols="12">
            <!-- input fields section -->
           <v-row class="ma-1 pa-1">
             <v-col cols="5" class="mt-5" style="margin-right:5px"  >
                        <v-menu
              ...
              <v-col class="mt-5" cols="5" style="margin-right:5px"  >
                        <v-menu
  ...
  <div v-else class="dropZone-uploaded">
    <div class="dropZone-uploaded-info">
      ...
      color="#03A9F4"
         ...
         <v-vol cols="4"  class="imgdiv">
          <img src="../../assets/profile-icon.png" height="60" width="60"/>
   </v-vol>
   <v-vol cols="4"  class="subTextDiv" style="margin-left: 30px;margin-top: 2px;width: 25vw;">
        <h3 color="#0398DC" style="text-align: start;font-size:18px !important;">
            {{singleEntity.name}}
        </h3>
        <p style="text-align: start;">www.assampvtltd.com</p>
      
  </v-vol>
           <v-vol cols="1">
                 <v-divider style="max-height: 63px;"
                
                vertical
         
                ></v-divider>
         </v-vol>
           <v-col cols="4" class="subColomn">
      <h5 style="font-size:18px !important;;font-weight: 500;">Type</h5>
      <p style="font-size:16px !important;">{{singleEntity.typeofcompany}}</p>
  </v-col>
            <v-vol cols="1">
                 <v-divider style="max-height: 63px;"
           ...
           <v-vol cols="4" class="subTextDiv" style="display: flex;justify-content: space-around;  margin-left: 115px;">
           <button large class="buttonPro-font ma-2 pa-2" @click="addProprietor()">
                <v-icon style="font-size: 25px !important;color: #c3c3c3;">mdi-briefcase-download-outline</v-icon>
                   
            </button>
              <button large class="buttonPro-font ma-2 pa-2" @click="addProprietor()">
                <v-icon style="font-size: 25px !important;color: #c3c3c3;">mdi-lock</v-icon>
                   
            </button>
              <button large class="buttonPro-font ma-2 pa-2" @click="addProprietor()">
                <v-icon style="font-size: 25px !important;color: #c3c3c3;">mdi-share</v-icon>
                   
            </button>
         </v-vol>
     </v-row>
     <v-divider class="blueUline"></v-divider>
     <v-row v-if="!showEntityPage" style="margin-left: 20px;margin-right:20px">
       <v-col cols="12" class="d-flex flex-row mb-4 beVietnamFont" style="margin-top: 30px;">
    ...
    <button class="buttonPro-font" @click="showAddUserPopUp">
             ...
             <v-divider style="max-height: 7px !important;min-height: 25px;margin-top: 10px;"
      class="mx-4"
      vertical
    ></v-divider>
      ...
      <v-col cols="3">
         ...
         v-if="!showEntityInfo"
                ...
                ></v-text-field>
                  <v-btn
               v-if="showEntityInfo"
                style="float:right;width:140px;margin-right:50px;color:white"
                color="#03a9f4"
   ...
   <h5>{{$moment(item.period_from).format("YYYY")}} -  {{$moment(item.to).format("YYYY")}}</h5>
...
<v-menu
     ...
     <v-row v-if="showEntityPage" align="center" class="ma-3">
       <v-col cols="9">
             <h2 color="#03a9f4" style="color:#03a9f4;float:left;margin-left: 8px;
    font-size: 17px !important;
    font-weight: 500;    margin-top: 5px;
    margin-bottom: 10px;">Address</h2>
  </v-col>
    ...
    <v-col cols="3" class="ma-2 " >
             <v-select
                    v-model="singleEntity.state" style="margin-bottom: 13px !important;"
                    :items="this.location.getAllStatesFromCountry(singleEntity.country)"
                    :rules="[v => !!v || 'State is required']"
                    item-text="name"
                    item-value="name"
                    label="State" hide-details
                   outlined
                    dense
                    required>
                </v-select>
    ...
    <v-col cols="3" class="ma-2 " >
          <v-select
                    v-model="singleEntity.country" style="margin-bottom: 13px !important;"
    ...
    font-size: 17px !important;
    font-weight: 500;   margin-top: 5px;
    margin-bottom: 10px;">Registration Info</h2>
  </v-col>
   <v-col cols="3" class="ma-2" >
           <v-text-field hide-details style="margin-bottom: 13px !important;"
  ...
  <v-col cols="12">
    ...
    font-size: 17px !important;
    font-weight: 500;   margin-top: 5px;
    margin-bottom: 10px;">Partners</h2>
  </v-col>
   <v-col cols="3" class="ma-2" >
           <v-text-field hide-details style="margin-bottom: 13px !important;"
  ...
  <v-col cols="12">
            ...
            >
                ...
                class="ma-2 button-font"
                color="#03a9f4"
                style="background-color: #0398DC !important;border-color:#0398DC !important; text-transform:none;float:right;color:white"
...
<script>
 ...
 export default {
  ...
  snackbar:{text:"test",active:false,type:'success'},
     showEntityInfo:false,
      showEntityPage:false,
        ...
        availableEmails:["asimpremji@tecs.com","elonmust@tecs.com","bajlel@tecs.com","nee@tecs.com","asimpremji@tecs.com","elonmust@tecs.com"],
         ...
         singleEntity:{registrationinfo:{},patner:{}}
   ...
   console.log( this.singleEntity,"singleentity")
   ...
   if(this.singleEntity.patners!=null){
     this.singleEntity.patners=this.singleEntity.patners[0]?this.singleEntity.patners[0]:{};
   }else{
...
updateObject.entityId=this.singleEntity.id;
 ...
 updateObject.street=this.singleEntity.street;
